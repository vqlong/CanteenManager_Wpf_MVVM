...
{
    public class TableData : DataAccess, ITableData
    {
        private TableData() { }
        ...
        {
            var firstBillId = BillData.Instance.GetUnCheckBillIdByTableId(firstTableId);
            var secondBillId = BillData.Instance.GetUnCheckBillIdByTableId(secondTableId);
